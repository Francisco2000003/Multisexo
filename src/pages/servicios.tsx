...
import heroImg from "../assets/msvoserv.png";
type Servicio = {
  id: number;
  titulo: string;
  descripcion: string;
  ...
  return (
    <>
      ...
      <section className="relative">
        ...
        style={{
          backgroundImage: `url(${heroImg})`, // 👈 úsala aquí
          }}
        />
      ...
      <section className="py-14 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-10">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Experiencias de clientes</h2>
            <p className="text-gray-900 mt-1">
